  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', gap: '6px' }}>
        <div className="skeleton-box" style={{ height: '18px', width: '75px', borderRadius: '20px' }} />
        <div className="skeleton-box" style={{ height: '18px', width: '65px', borderRadius: '20px' }} />
      </div>
      <div style={{ display: 'flex', gap: '6px', alignItems: 'center' }}>
        <div className="skeleton-box" style={{ height: '13px', width: '70px', borderRadius: '4px' }} />
        <div className="skeleton-box" style={{ height: '13px', width: '95px', borderRadius: '4px' }} />
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '7px', paddingTop: '2px' }}>
